...
class Student_model extends CI_Model
{
    ...
    function get($params = array())
    {
        ...
        $this->db->select('student.student_id, SaldoBulanan, SaldoBebas, student_nis, student_nisn, student_password, student_gender, student_phone, student_hobby, student_address, student_parent_phone, student_full_name, student_born_place, student_born_date, student_img, student_status, student_name_of_mother, student_name_of_father, student_input_date, student_last_update');
        $this->db->select('bulan.student_student_id, student_img, student_nis, student_full_name, student_name_of_mother, student_parent_phone, student.class_class_id, student.majors_majors_id, majors_name, majors_short_name, class_name');
        $this->db->select('class_class_id, class.class_name');
        $this->db->select('majors_majors_id, majors.majors_name, majors_short_name');
        $this->db->select('bulan.payment_payment_id, period_period_id, period_status, period_start, period_end, pos_name, payment_type');
        $this->db->select('bebas_id, bebas_bill, bebas.student_student_id as bebas_student_student_id, bebas.payment_payment_id as bebas_payment_payment_id');
        ...
        $this->db->join('bebas', 'student.student_id = bebas.student_student_id', 'left');
    ...
    function add($data = array())
    {
        ...
        if (isset($data['SaldoBulanan'])) {
         ...
         if (isset($data['SaldoBebas'])) {
            $this->db->set('SaldoBebas', 'SaldoBebas + ' . $data['SaldoBebas'], FALSE);
        }
